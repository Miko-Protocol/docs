...
graph TD
    subgraph "On-Chain Programs"
        ...
        C[("Smart Dial<br><i>Stores Weekly Selection Asset Address</i>")]
    end
    ...
    subgraph "Workflow"
        ...
        C -- "4#46; Queries AI-Selected<br>Asset Address" --> D
        D -- "3#46; Processes Fees<br>(Swap & Distribution Logic)" --> E
        E>"Selected Asset allocated<br>to <b>Eligible Holders</b>"]
    end
...
```mermaid
graph TD
    A["Miko Intelligence Stack<br/>selects weekly asset"] --> B["On-Chain Execution Module"]
    B --> C["Automatic Harvesting:<br/>Monitors fees, harvests<br/>at 500K MIKO threshold"]
    B --> D["Swap Execution:<br/>Swaps MIKO for<br/>AI-selected asset"]
    ...
    D --> G["Allocation:<br/>Selected Asset to<br/>Eligible Holders (pro-rata)"]
