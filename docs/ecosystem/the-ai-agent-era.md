...
graph TD
    ...
    subgraph "Agent Capabilities"
        ...
        L["AI-Managed Vaults<br/>(e.g. Theoriq: $25M TVL)"]
    end
    A --> H
    B --> H
    C --> J
...
-   **Hermes Agent** (Nous Research) emerged in February 2026 as a leading Solana-based open-source personal AI agent, reaching 242 contributors and 8 major 
...
**The output of by AI agent activity does not reach to token holders in a structured, automatic, and verifiable way.**
...
| **AIXBT** | 445K followers, real-time analysis of 400+ KOLs | \$AIXBT holders read analysis. No on-chain mechanism delivers agent output to holder wallets. |
| **Theoriq** | \$25M TVL managed by autonomous agents | Returns go to vault depositors. Token holders broadly receive nothing from agent activity. |
...
## 4. MIKO's Position: AI-Curated Solana Index
...
> **It takes the AI's analytical output, acquires the selected asset on-chain, and allocates it directly to every eligible token holder. Every week, automatically, with a trackable performance record.**
