...
The \$MIKO token's role differs from that of governance, utility, or a AI narrative speculation tokens. It is the **medium through which an AI's analytical output is converted into weekly on-chain asset allocations for its holders**. Every week:
...
graph LR
    ...
    A -->|"MIKO Protocol"| C["Weekly Asset Allocation<br/>to Every Eligible<br/>Holder"]
...
MIKO does one thing: **it converts AI analysis into a weekly on-chain asset allocation in your wallet**.
